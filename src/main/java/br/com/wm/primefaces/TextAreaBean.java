...
public class TextAreaBean implements Serializable {
	...
	public List<String> completarTexto(String consulta) {
		...
		if (consulta.startsWith("Wil")) {
			resultados.add("William");
			resultados.add("William Foleis");
			resultados.add("William Foleis Mian");
			resultados.add("William Desenvolvedor Java");
		}
